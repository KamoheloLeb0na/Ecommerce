import data from "/home/kamohelo/Desktop/ILL BE OFFLINE FOR A WHILE/Maths/src/data/lgcsepaper4"
...
export default function Paper4(){
    ...
    return(
        ...
        <div>
            <h1 style={{position:"fixed",left:10,top:0,marginBottom:"60px"}}>Math Paper 4 LGCSE</h1>

            {
                download ?
                <div style={{display:"flex",alignItems:"center",marginTop:"60px"}}>
                    <IconButton sx={{color:"black"}} href="/lgcsepaper4">
                        <ArrowBackIosRounded/>
